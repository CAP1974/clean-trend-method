        ...
        <div className="two-col">
          <div className="reveal">
            ...
            <div className="channel-row">
              <a href="https://t.me/cleantrendmethod" target="_blank" rel="noopener noreferrer" className="ch-badge">
              ...
              <a href="https://cleantrendmethod.substack.com" target="_blank" rel="noopener noreferrer" className="ch-badge">
              ...
              <a href="https://wa.me/351963537100" target="_blank" rel="noopener noreferrer" className="ch-badge">
              ...
              <a href="mailto:ctmpro2026@gmail.com" className="ch-badge">
      ...
      <footer>
        <div className="inner">
          ...
          <div className="footer-col">
            <h5>Canais</h5>
            <ul>
              <li><a href="https://t.me/cleantrendmethod" target="_blank" rel="noopener noreferrer">Telegram</a></li>
              <li><a href="https://cleantrendmethod.substack.com" target="_blank" rel="noopener noreferrer">Substack</a></li>
              <li><a href="https://wa.me/351963537100" target="_blank" rel="noopener noreferrer">WhatsApp</a></li>
              <li><a href="mailto:ctmpro2026@gmail.com">ctmpro2026@gmail.com</a></li>
            </ul>
          </div>
        </div>
